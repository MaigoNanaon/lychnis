...
const SONGS = [
  {
    ...
    segments: [
      ...
      { type: 'tutorial', beatStart: 15.5,   beatEnd: 19.5,  notes: [16, 17, 18, 19] , message:"扫描线消失！" },
  ...
  },
  {
    ...
    segments: [
      ...
      { type: 'tutorial', beatStart: 47,   beatEnd: 59.5, notes: [48, 51, 52, 53, 54, 57, 58, 59 ], message:"扫描线消失！" },
